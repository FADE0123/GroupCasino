...
class RoulettePlayerTest {
    ...
    void getArcadeAccount1() {
        player = new RoulettePlayer("Player", "Pass");
    ...
    void getArcadeAccount2() {
        player = new RoulettePlayer("Person", "Sapp");
        CasinoAccountManager.casinoAccountList.set(0, player);
    ...
    void getArcadeAccount3() {
        player = new RoulettePlayer("People", "Apps");
        CasinoAccountManager.casinoAccountList.set(0, player);
    ...
    void getArcadeAccount4() {
        player = new RoulettePlayer("Human", "Pssa");
        CasinoAccountManager.casinoAccountList.set(0, player);
    ...
    void getArcadeAccount5() {
        player = new RoulettePlayer("Body", "Spaa");
        CasinoAccountManager.casinoAccountList.set(0, player);
    ...
    void getArcadeAccount6() {
        player = new RoulettePlayer("Cadaver", "Ppsa");
        CasinoAccountManager.casinoAccountList.set(0, player);
